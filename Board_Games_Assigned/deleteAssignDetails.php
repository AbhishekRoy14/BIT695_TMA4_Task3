				...
				<section class="content_pages">
					...
					<div class="container">
						...
						<?php
							...
							//DELETE data from board_games_assigned database
							{$stmt = $conn->prepare("DELETE FROM board_games_assigned WHERE memberID_fk = ?");
								
								/* Bind the params */
								$stmt->bind_param('i', $memberID_fk = $_GET['memberID_fk']);
								...
								header("refresh:1; url=deleteAGConfirm.htm");
								/* Close the statement */
								$stmt->close();
